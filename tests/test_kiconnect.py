...
class TestKIConnectProvider:
    ...
    def test_initialization_success(self):
        ...
        with patch("llm_client.providers.providers.OpenAI") as mock_openai:
            ...
            provider = KIConnectProvider(
                llm="GPT 5.4 mini", temperature=0.7, max_tokens=512, api_key="kiconnect-test"
            )
    ...
    def test_initialization_without_api_key_raises_error(self):
        ...
        with pytest.raises(
            ...
            KIConnectProvider(llm="GPT 5.4 mini", temperature=0.7, max_tokens=512)
    ...
    def test_chat_completion_success(self):
        ...
        with patch("llm_client.providers.providers.OpenAI") as mock_openai:
            ...
            provider = KIConnectProvider(llm="GPT 5.4 mini", api_key="test")
